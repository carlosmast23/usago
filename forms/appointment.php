<?php
  ...
  * For more info and help: https://codesoft.com/php-email-form/
  */

  // Replace info@usago.com with your real receiving email address
  $receiving_email_address = 'info@usago.com';
